...
* Section : 1
* Assignment : 4
* Description : This is the untouched graph.h file.
*/
...
public:
   ...
   /**
    * Finds the number of times that performer1 and performer2 performed together.
    */
   int findFrequency(string performer1, string performerOrDirector);

   /**
    * Finds the highest occurence between a people with a given map of names and occurances.
    */
   int findHighestFrequency( map<string, int> partnershipMap);
